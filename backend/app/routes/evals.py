...
def _task_to_eval(task: dict[str, Any], benchmark: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    task_contract["completeness"] = task_contract_completeness(task_contract)
...
async def list_benchmarks(email: str, companyId: str = ""):
    ...
    return {
        ...
        "coveragePortfolio": coverage_portfolio([benchmark.get("coverage") or {} for benchmark in benchmark_payloads]),
    }
